...
function demo_theme_scripts() {
    wp_enqueue_script('handle', 'src', array(), 'version', boolean);   
    wp_enqueue_style('handle', 'src');
	wp_enqueue_style( 'demo-theme-style', get_stylesheet_uri() );
        
        wp_enqueue_style( 'demo-theme-bootstrapcss', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
        
        wp_enqueue_script( 'demo-bootstrapjs', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js', array(jquery), '20161203', true );
