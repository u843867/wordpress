...
function testtheme_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'testtheme' ),
	) );
...
function testtheme_scripts() {
	wp_enqueue_style( 'testtheme-style', get_stylesheet_uri() );
        ...
        wp_enqueue_style( 'test_theme-bootstrapcss', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
        
        wp_enqueue_script( 'test_theme-bootstrapjs', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js', array('jquery'), '20161128', true );
