...
class wp_beta_tester {
	...
	function action_admin_head_plugins_php() {
		...
		if ( $this->check_if_settings_downgrade() ) {
			?>
				<div id="message" class="error"><p><?php printf( __('<strong>Error:</strong> Your current <a href="%1$s">WordPress Beta Tester plugin configuration</a> will downgrade your install to a previous version - please reconfigure it.', 'wordpress-beta-tester'), admin_url('tools.php?page=wp_beta_tester') ); ?></p></div>
			<?php
		}
	}
	...
	function action_admin_menu() {
		add_management_page(__('Beta Testing WordPress', 'wordpress-beta-tester'), __('Beta Testing', 'wordpress-beta-tester'), 'update_plugins', 'wp_beta_tester', array(&$this,'display_page'));
	}
	...
	<div class="wrap"><?php screen_icon(); ?>
		...
		<div>
			...
			<fieldset><legend><?php _e('Please select the update stream you would like this blog to use:', 'wordpress-beta-tester'); ?></legend>
				<?php
				$stream = get_option('wp_beta_tester_stream','point');
				?>
			<table class="form-table">
				<tr>
					<th><label><input name="wp_beta_tester_stream"
						...
						class="tog" <?php checked('point', $stream); ?> /><?php _e('Point release nightlies', 'wordpress-beta-tester'); ?></label></th>
				...
				<tr>
					<th><label><input name="wp_beta_tester_stream"
						...
						class="tog" <?php checked('unstable', $stream); ?> /><?php _e('Bleeding edge nightlies', 'wordpress-beta-tester'); ?></label></th>
